...
import CmsContent from '~/modules/portal/components/CmsContent';
...
export const MultipleLines: Story = {
    args: {
        content: [
            '<p>Culpa occaecat ut do laborum laborum irure consequat. Elit pariatur dolor cillum mollit culpa consequat incididunt quis id sunt voluptate. Dolore irure aute incididunt veniam et laboris nisi nostrud adipisicing aute.</p>',
            '<p>Sunt anim pariatur nisi ad enim. In dolore aliquip sunt commodo aliqua nisi aute velit sint labore velit ut veniam. Excepteur cupidatat pariatur Lorem consectetur ut cillum. Ipsum nostrud reprehenderit duis in aute ullamco laborum esse minim laborum magna laborum officia do.</p>',
        ],
    },
};
